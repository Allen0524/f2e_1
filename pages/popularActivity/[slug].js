    ...
    <>
      ...
      <SmallLayout>
        <main className="max-w-7xl mx-auto px-8 sm:px-16">
          <h1 className="font-semibold text-2xl mb-3">{data.ActivityName}</h1>
...
export async function getServerSideProps(context) {
  ...
  const res = await axios.get(
    `https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity?$filter=contains(ActivityID, '${params.slug}')&$format=JSON`,
